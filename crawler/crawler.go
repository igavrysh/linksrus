...
import (
	...
	"github.com/igavrysh/linksrus/pipeline"
	"github.com/igavrysh/linksrus/textindexer/index"
	"net/http"
	"time"
)

//go:generate mockgen -package mocks -destination mocks/mocks.go github.com/igavrysh/linksrus/crawler URLGetter,PrivateNetworkDetector,Graph,Indexer
