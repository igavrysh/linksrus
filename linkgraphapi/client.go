...
//go:generate mockgen -package mocks -destination mocks/mock.go github.com/igavrysh/linksrus/linkgraphapi/proto LinkGraphClient,LinkGraph_LinksClient,LinkGraph_EdgesClient
