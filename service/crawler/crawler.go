...
import (
	...
	crawler_pipeline "github.com/igavrysh/linksrus/crawler"
	"github.com/igavrysh/linksrus/crawler/privnet"
	"github.com/igavrysh/linksrus/linkgraph/graph"
	"github.com/igavrysh/linksrus/partition"
	"github.com/igavrysh/linksrus/textindexer/index"
...
//go:generate mockgen -package mocks -destination mocks/mocks.go github.com/igavrysh/linksrus/service/crawler GraphAPI,IndexAPI
//go:generate mockgen -package mocks -destination mocks/mock_iterator.go github.com/igavrysh/linksrus/linkgraph/graph LinkIterator
...
func (svc *Service) Run(ctx context.Context) error {
	svc.cfg.Logger.
		WithField("update_interval", svc.cfg.UpdateInterval.String()).
