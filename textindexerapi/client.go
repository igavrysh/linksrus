...
import (
	...
	"github.com/igavrysh/linksrus/textindexerapi/proto"
	"io"
)

//go:generate mockgen -package mocks -destination mocks/mock.go github.com/igavrysh/linksrus/textindexerapi/proto TextIndexerClient,TextIndexer_SearchClient
